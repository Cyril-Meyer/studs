...
function sous_bandeau_light(){
	echo '<div class="sousbandeau"><input type=submit class=boutonsousbandeau name=annuler value='.$GLOBALS["tt_bouton_accueil"].'><input type=image class=drapeausousbandeau alt=france src="images/france.png" name="france"><input type=image class=drapeausousbandeau alt=uk src="images/uk.png" name="uk"><input type=image class=drapeausousbandeau alt=deutschland src="images/germany.png" name="germany"></div>'."\n";
}
function sous_bandeau_admin(){
	echo '<div class="sousbandeau"><input type=submit class=boutonsousbandeau name=annuler value='.$GLOBALS["tt_bouton_accueil"].'><input type=submit class=boutonsousbandeau name=historique value='.$GLOBALS["tt_bouton_historique"].'><input type=image class=drapeausousbandeau alt=france src="../images/france.png" name="france"><input type=image class=drapeausousbandeau alt=uk src="../images/uk.png" name="uk"><input type=image class=drapeausousbandeau alt=deutschland src="../images/germany.png" name="germany"></div>'."\n";
}
