...
if ($_SESSION["formatsondage"]=="D+"||$_SESSION["formatsondage"]=="A+"){
	...
	if ($_SESSION["formatsondage"]=="D+"||$_SESSION["formatsondage"]=="A+"){
		header("Location:studsplus.php?sondage=$sondage");
	}
	else{
